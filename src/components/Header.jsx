      ...
      <div className="bg-primary text-white py-2">
        <div className="container flex flex-col sm:flex-row justify-between items-center">
          <div className="flex space-x-6 mb-2 sm:mb-0">
            <a href="tel:7904064469" className="flex items-center hover:text-accent transition-colors">
              <PhoneIcon className="h-4 w-4 mr-1" />
              <span>7904064469</span>
            </a>
            <a href="mailto:example@gmail.com" className="flex items-center hover:text-accent transition-colors">
